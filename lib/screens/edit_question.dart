...
class EditPertanyaan extends StatefulWidget {
  final int initialIndex, id;
  ...
  @override
  _EditPertanyaanState createState() => _EditPertanyaanState();
}

class _EditPertanyaanState extends State<EditPertanyaan> {
  TextEditingController title = TextEditingController();
  TextEditingController description = TextEditingController();
  TextEditingController tag = TextEditingController();
  final List<Widget> _tabs = [
    const Tab(text: 'Edit Pertanyaan'),
  ...
  void initState() {
    ...
    tag.text = widget.tag == null ? "" : widget.tag;
    getIlmu();
  }
