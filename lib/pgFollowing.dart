  ...
  Future<void> _fetchPage(int page) async {
    try {
      ...
      final response = await http.get(
        // Uri.parse(
        //     "http://10.0.2.2:8000/api/posting/following?page=$pageKey&limit=$_numberOfPostsPerRequest"),
        Uri.parse(
            "http://10.0.2.2:8000/api/posting/following?per_page=$_perPage&page=$page"),
        headers: {
