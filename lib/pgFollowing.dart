...
class PgFollowing extends StatefulWidget {
  const PgFollowing({super.key});

  @override
  State<PgFollowing> createState() => _PgFollowingState();
}
...
class _PgFollowingState extends State<PgFollowing> {
  bool follow = false;
  int following = 0;
  ...
  Future<List<PostHome>> fetch() async {
    ...
    final response = await http.get(
      ...
      Uri.parse(URL + "posting/following?per_page=$limit&page=$page"),
      headers: {
        "Authorization": 'Bearer ${data[0].token}',
        "Accept": "*/*",
        "login-type": "0",
